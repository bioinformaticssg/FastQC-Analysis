...
#$ -o /data/users/$USER/BioinformaticsSG/FastQC/fastqc_03.out   # contains what would normally be printed to stdout (the$
#$ -e /data/users/$USER/BioinformaticsSG/FastQC/fastqc_03.err   # file name to print standard error messages to. These m$
...
QC_OUT_DIR=/data/users/$USER/BioinformaticsSG/FastQC/fastqc_results_03
QC_HTML_DIR=/data/users/$USER/BioinformaticsSG/FastQC/fastqc_results_03/fastqc_html_03
